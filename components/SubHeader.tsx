  ...
  return (
    <div className="bg-white border-b-4 border-green-100 px-10 py-6 flex justify-between items-center relative shadow-sm">
      ...
      >
        ...
        <span className="text-[#1c6c3e] font-black text-xl uppercase tracking-widest">
          Atrás
        </span>
      </button>
      ...
      {isHome ? (
        ...
        >
          <span className="text-[#1c6c3e] font-black text-xl uppercase tracking-widest text-right">
            Inicio
          </span>
          <div className="bg-[#1c6c3e] p-4 rounded-2xl shadow-lg">
